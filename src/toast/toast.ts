...
export class Toast extends LitElement {
  ...
  private renderSuccessIcon = () => html`
    <svg
      width="25"
      height="24"
      viewBox="0 0 25 24"
  ...
  private renderDefaultIcon = () => html`
    <svg
      width="25"
      height="24"
      viewBox="0 0 25 24"
  ...
  render() {
    return html`
      ...
      >
        <span class="toast-icon" id="toast-icon"> ${this.renderIcon()} </span>
